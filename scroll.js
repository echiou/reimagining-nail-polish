$(document).ready(function(){
    ...
    $(document).scroll(function(){
        ...
        if($(this).scrollTop() > 1060 && $(this).scrollTop() < 2184)
        {   
            $(".sect1").removeClass("current");
            $(".sect3").removeClass("current");
            $(".sect4").removeClass("current");
        ...
        if($(this).scrollTop() > 2184 && $(this).scrollTop() < 2642)
        {   
            $(".sect1").removeClass("current");
            $(".sect2").removeClass("current");
            $(".sect4").removeClass("current");
        ...
        if($(this).scrollTop() > 2642 && $(this).scrollTop() < 3000 || $(window).scrollTop() + $(window).height() == $(document).height())
        {   
            $(".sect1").removeClass("current");
            $(".sect2").removeClass("current");
            $(".sect3").removeClass("current");
